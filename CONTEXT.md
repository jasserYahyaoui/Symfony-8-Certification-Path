...
| 06 (Twig) | **en cours** — pages 1 à 8 fusionnées et déployées ; page 9 en PR | `docs/progress/lot-06-refinement.md` |
...
**Prochaine action** : fusionner la PR de la page 9 du lot 06 après CI verte,
lire son smoke test, puis page 10 (*Controller rendering*).
