...
| 07 (Forms) | **en cours** — pages 1 et 2 déployées ; page 3 en PR | `docs/progress/lot-07-refinement.md` |
...
**Prochaine action** : fusionner la PR de la page 3 du lot 07 après CI verte,
lire son smoke test, puis page 4 (*Form types*).
