...
| 06 (Twig) | **en cours** — pages 1 à 6 fusionnées et déployées ; page 7 en PR | `docs/progress/lot-06-refinement.md` |
...
**Prochaine action** : fusionner la PR de la page 7 du lot 06 après CI verte,
lire son smoke test, puis page 8 (*Loops and conditions*).
