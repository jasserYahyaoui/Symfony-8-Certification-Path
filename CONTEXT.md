...
| 07 (Forms) | **en cours** — pages 1 à 7 déployées ; page 8 en PR | `docs/progress/lot-07-refinement.md` |
...
**Prochaine action** : fusionner la PR de la page 8 du lot 07 après CI verte,
lire son smoke test, puis page 9 (*Built-in form types*).
