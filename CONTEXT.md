...
| 06 (Twig) | **en cours** — pages 1 à 7 fusionnées et déployées ; page 8 en PR | `docs/progress/lot-06-refinement.md` |
...
**Prochaine action** : fusionner la PR de la page 8 du lot 06 après CI verte,
lire son smoke test, puis page 9 (*URLs generation*).
