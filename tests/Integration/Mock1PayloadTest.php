...
/**
 * Master Plan §10 — Mock 1, Knowledge.
 *
 ...
 */
final class Mock1PayloadTest extends TestCase
{
    private const string MOCK = 'mock-1';
    ...
    public function testEveryEligibleQuestionIsAValidationQuestionOnItsOwnItem(): void
    {
        ...
        foreach ($payload['questions'] as $exported) {
            ...
            self::assertContains($question->examSkill, ['RECOGNIZE', 'DISTINGUISH'], $question->id->value.' is not a knowledge check');
