# Calendrier de révision — jour par jour

Généré depuis les fichiers canoniques par `tools/revision/build_roadmap.py`.
Les durées viennent du corpus mesuré ; le modèle d'effort et ses **hypothèses**
sont dans [`study-roadmap.md`](study-roadmap.md#le-modèle-deffort).

**Convention.** `NOUVEAU` = première passe. `J+n` = révision espacée de l'item
étudié n jours plus tôt. Les minutes sont un budget, pas un chronomètre : si un
...
- **Source tour et mise en pratique** sur les 8 items de la semaine :
...
- NOUVEAU · **HTTP : Status codes** (MINIMAL) — 26 min · 666 mots · 4 questions, 17 flashcards
...
- NOUVEAU · **Symfony Architecture : Event dispatcher and kernel events** (DEEP) — 28 min · 1038 mots · 6 questions, 19 flashcards
...
- **Source tour et mise en pratique** sur les 20 items de la semaine :
  ...
  - HTTP : Symfony HttpClient component
  - Symfony Architecture : HttpFoundation component
  - Symfony Architecture : Symfony Flex
  ...
  - méthode : ouvrir les `official_sources` de chaque item dans `docs/syllabus/syllabus-matrix.yml`, lire le code ou la doc ancrée sur `8.0`, reproduire le comportement décrit
- Révision **J+1** (20 min) — Symfony Architecture : Code organization · Symfony Architecture : Request handling · Symfony Architecture : Exception handling
...
- **Source tour et mise en pratique** sur les 20 items de la semaine :
  ...
  - Symfony Architecture : Naming conventions
  - Controllers : HttpKernel component and FrameworkBundle
  - Controllers : Naming conventions
  - Controllers : The base AbstractController class
  - Controllers : The request
  - Controllers : The response
  - Controllers : The cookies
  - Controllers : The session
  - Controllers : The flash messages
  - Controllers : HTTP redirects
  - Controllers : Internal redirects
  - Controllers : Generate 404 pages
  - méthode : ouvrir les `official_sources` de chaque item dans `docs/syllabus/syllabus-matrix.yml`, lire le code ou la doc ancrée sur `8.0`, reproduire le comportement décrit
- Révision **J+1** (20 min) — Controllers : The flash messages · Controllers : HTTP redirects · Controllers : Internal redirects · Controllers : Generate 404 pages
- Révision **J+3** (14 min) — Controllers : HttpKernel component and FrameworkBundle · Controllers : Naming conventions · Controllers : The base AbstractController class · Controllers : The request
...
- Révision **J+3** (11 min) — Controllers : The response · Controllers : The cookies · Controllers : The session
- Consolidation : reprendre les questions ratées de la semaine, rattrapage de ce qui a débordé
...
- Révision **J+3** (14 min) — Controllers : The flash messages · Controllers : HTTP redirects · Controllers : Internal redirects · Controllers : Generate 404 pages
...
- Révision **J+1** (26 min) — Controllers : File upload · Controllers : Built-in internal controllers · Controllers : Argument value resolvers · Routing : Routing component and FrameworkBundle
...
- Révision **J+1** (24 min) — Routing : Configuration (YAML and PHP attributes) · Routing : Restrict URL parameters · Routing : Set default values to URL parameters · Routing : URLs generation
...
- Révision **J+1** (22 min) — Routing : Trigger redirects · Routing : Special internal routing attributes · Routing : Domain name matching · Routing : Conditional request matching
- Révision **J+3** (17 min) — Controllers : File upload · Controllers : Built-in internal controllers · Controllers : Argument value resolvers · Routing : Routing component and FrameworkBundle
...
- Révision **J+1** (20 min) — Routing : HTTP methods matching · Routing : User's locale guessing · Routing : Router debugging · Dependency Injection : Dependency Injection component
- Révision **J+3** (16 min) — Routing : Configuration (YAML and PHP attributes) · Routing : Restrict URL parameters · Routing : Set default values to URL parameters · Routing : URLs generation
- Révision **J+7** (14 min) — Controllers : The flash messages · Controllers : HTTP redirects · Controllers : Internal redirects · Controllers : Generate 404 pages
...
- **Source tour et mise en pratique** sur les 20 items de la semaine :
  ...
  - Routing : Restrict URL parameters
  - Routing : Set default values to URL parameters
  - Routing : URLs generation
  - Routing : Trigger redirects
  - Routing : Special internal routing attributes
  - Routing : Domain name matching
  - Routing : Conditional request matching
  - Routing : HTTP methods matching
  - Routing : User's locale guessing
  - Routing : Router debugging
  - Dependency Injection : Dependency Injection component
  - Dependency Injection : Service container
  - Dependency Injection : Built-in services
  - Dependency Injection : Configuration parameters
  - Dependency Injection : Services registration (YAML and PHP attributes)
  - méthode : ouvrir les `official_sources` de chaque item dans `docs/syllabus/syllabus-matrix.yml`, lire le code ou la doc ancrée sur `8.0`, reproduire le comportement décrit
- Révision **J+1** (22 min) — Dependency Injection : Service container · Dependency Injection : Built-in services · Dependency Injection : Configuration parameters · Dependency Injection : Services registration (YAML and PHP attributes)
- Révision **J+3** (15 min) — Routing : Trigger redirects · Routing : Special internal routing attributes · Routing : Domain name matching · Routing : Conditional request matching
...
- Révision **J+3** (14 min) — Routing : HTTP methods matching · Routing : User's locale guessing · Routing : Router debugging · Dependency Injection : Dependency Injection component
- Consolidation : reprendre les questions ratées de la semaine, rattrapage de ce qui a débordé
...
- Révision **J+3** (15 min) — Dependency Injection : Service container · Dependency Injection : Built-in services · Dependency Injection : Configuration parameters · Dependency Injection : Services registration (YAML and PHP attributes)
- Révision **J+7** (17 min) — Controllers : File upload · Controllers : Built-in internal controllers · Controllers : Argument value resolvers · Routing : Routing component and FrameworkBundle
...
- Révision **J+1** (24 min) — Dependency Injection : Service decoration · Dependency Injection : Tags · Dependency Injection : Semantic configuration · Dependency Injection : Factories
- Révision **J+7** (16 min) — Routing : Configuration (YAML and PHP attributes) · Routing : Restrict URL parameters · Routing : Set default values to URL parameters · Routing : URLs generation
...
- Révision **J+1** (28 min) — Dependency Injection : Compiler passes · Dependency Injection : Services autowiring · Dependency Injection : Service locators · Data Validation : Validator component
- Révision **J+7** (15 min) — Routing : Trigger redirects · Routing : Special internal routing attributes · Routing : Domain name matching · Routing : Conditional request matching
- Révision **J+14** (10 min) — Controllers : HttpKernel component and FrameworkBundle · Controllers : Naming conventions · Controllers : The base AbstractController class · Controllers : The request
...
- Révision **J+1** (24 min) — Data Validation : PHP object validation · Data Validation : Built-in validation constraints · Data Validation : Validation scopes · Data Validation : Validation groups
- Révision **J+3** (16 min) — Dependency Injection : Service decoration · Dependency Injection : Tags · Dependency Injection : Semantic configuration · Dependency Injection : Factories
- Révision **J+7** (14 min) — Routing : HTTP methods matching · Routing : User's locale guessing · Routing : Router debugging · Dependency Injection : Dependency Injection component
- Révision **J+14** (8 min) — Controllers : The response · Controllers : The cookies · Controllers : The session
...
- NOUVEAU · **Forms : Form types (built-in and custom)** (STANDARD) — 11 min · 427 mots · 5 questions, 1 flashcards
- NOUVEAU · **Forms : Forms rendering with Twig** (STANDARD) — 11 min · 410 mots · 4 questions, 1 flashcards
- Révision **J+1** (26 min) — Data Validation : Group sequence · Data Validation : Custom callback validators · Data Validation : Violations builder · Forms : Form component
- Révision **J+3** (18 min) — Dependency Injection : Compiler passes · Dependency Injection : Services autowiring · Dependency Injection : Service locators · Data Validation : Validator component
- Révision **J+7** (15 min) — Dependency Injection : Service container · Dependency Injection : Built-in services · Dependency Injection : Configuration parameters · Dependency Injection : Services registration (YAML and PHP attributes)
- Révision **J+14** (10 min) — Controllers : The flash messages · Controllers : HTTP redirects · Controllers : Internal redirects · Controllers : Generate 404 pages
...
- **Source tour et mise en pratique** sur les 20 items de la semaine :
  - Dependency Injection : Service decoration
  - Dependency Injection : Tags
  - Dependency Injection : Semantic configuration
  - Dependency Injection : Factories
  - Dependency Injection : Compiler passes
  - Dependency Injection : Services autowiring
  - Dependency Injection : Service locators
  - Data Validation : Validator component
  - Data Validation : PHP object validation
  - Data Validation : Built-in validation constraints
  - Data Validation : Validation scopes
  - Data Validation : Validation groups
  - Data Validation : Group sequence
  - Data Validation : Custom callback validators
  - Data Validation : Violations builder
  - Forms : Form component
  - Forms : Forms creation
  - Forms : Forms handling
  - Forms : Form types (built-in and custom)
  - Forms : Forms rendering with Twig
  - méthode : ouvrir les `official_sources` de chaque item dans `docs/syllabus/syllabus-matrix.yml`, lire le code ou la doc ancrée sur `8.0`, reproduire le comportement décrit
- Révision **J+1** (24 min) — Forms : Forms creation · Forms : Forms handling · Forms : Form types (built-in and custom) · Forms : Forms rendering with Twig
- Révision **J+3** (16 min) — Data Validation : PHP object validation · Data Validation : Built-in validation constraints · Data Validation : Validation scopes · Data Validation : Validation groups
...
- Révision **J+3** (17 min) — Data Validation : Group sequence · Data Validation : Custom callback validators · Data Validation : Violations builder · Forms : Form component
...
- Révision **J+3** (16 min) — Forms : Forms creation · Forms : Forms handling · Forms : Form types (built-in and custom) · Forms : Forms rendering with Twig
- Révision **J+7** (16 min) — Dependency Injection : Service decoration · Dependency Injection : Tags · Dependency Injection : Semantic configuration · Dependency Injection : Factories
- Révision **J+14** (13 min) — Controllers : File upload · Controllers : Built-in internal controllers · Controllers : Argument value resolvers · Routing : Routing component and FrameworkBundle
...
- Révision **J+1** (20 min) — Forms : Forms theming · Forms : CSRF protection · Forms : Handling file upload · Forms : Built-in form types
- Révision **J+7** (18 min) — Dependency Injection : Compiler passes · Dependency Injection : Services autowiring · Dependency Injection : Service locators · Data Validation : Validator component
- Révision **J+14** (12 min) — Routing : Configuration (YAML and PHP attributes) · Routing : Restrict URL parameters · Routing : Set default values to URL parameters · Routing : URLs generation
...
- Révision **J+1** (24 min) — Forms : Data transformers · Forms : Form events · Forms : Form type extensions · Forms : Form options (OptionsResolver component)
- Révision **J+7** (16 min) — Data Validation : PHP object validation · Data Validation : Built-in validation constraints · Data Validation : Validation scopes · Data Validation : Validation groups
- Révision **J+14** (11 min) — Routing : Trigger redirects · Routing : Special internal routing attributes · Routing : Domain name matching · Routing : Conditional request matching
...
- NOUVEAU · **Security : Users** (STANDARD) — 12 min · 354 mots · 5 questions, 1 flashcards
- NOUVEAU · **Security : Password hashers** (STANDARD) — 10 min · 333 mots · 3 questions, 1 flashcards
- Révision **J+1** (24 min) — Security : Security Core, CSRF and PasswordHasher components · Security : Authentication · Security : Authorization · Security : Configuration
- Révision **J+3** (14 min) — Forms : Forms theming · Forms : CSRF protection · Forms : Handling file upload · Forms : Built-in form types
- Révision **J+7** (17 min) — Data Validation : Group sequence · Data Validation : Custom callback validators · Data Validation : Violations builder · Forms : Form component
- Révision **J+14** (10 min) — Routing : HTTP methods matching · Routing : User's locale guessing · Routing : Router debugging · Dependency Injection : Dependency Injection component
...
- Révision **J+1** (24 min) — Security : Providers · Security : Firewalls · Security : Users · Security : Password hashers
- Révision **J+3** (16 min) — Forms : Data transformers · Forms : Form events · Forms : Form type extensions · Forms : Form options (OptionsResolver component)
- Révision **J+7** (16 min) — Forms : Forms creation · Forms : Forms handling · Forms : Form types (built-in and custom) · Forms : Forms rendering with Twig
- Révision **J+14** (11 min) — Dependency Injection : Service container · Dependency Injection : Built-in services · Dependency Injection : Configuration parameters · Dependency Injection : Services registration (YAML and PHP attributes)
...
- **Source tour et mise en pratique** sur les 20 items de la semaine :
  ...
  - Forms : Form events
  - Forms : Form type extensions
  - Forms : Form options (OptionsResolver component)
  - Security : Security Core, CSRF and PasswordHasher components
  ...
  - méthode : ouvrir les `official_sources` de chaque item dans `docs/syllabus/syllabus-matrix.yml`, lire le code ou la doc ancrée sur `8.0`, reproduire le comportement décrit
- Révision **J+1** (26 min) — Security : Roles · Security : Access Control Rules · Security : Authenticators, Passports and Badges · Security : Voters and voting strategies
- Révision **J+3** (16 min) — Security : Security Core, CSRF and PasswordHasher components · Security : Authentication · Security : Authorization · Security : Configuration
...
- Révision **J+3** (16 min) — Security : Providers · Security : Firewalls · Security : Users · Security : Password hashers
- Révision **J+30** (10 min) — Symfony Architecture : Code organization · Symfony Architecture : Request handling · Symfony Architecture : Exception handling
- Consolidation : reprendre les questions ratées de la semaine, rattrapage de ce qui a débordé
...
- Révision **J+3** (17 min) — Security : Roles · Security : Access Control Rules · Security : Authenticators, Passports and Badges · Security : Voters and voting strategies
- Révision **J+7** (14 min) — Forms : Forms theming · Forms : CSRF protection · Forms : Handling file upload · Forms : Built-in form types
- Révision **J+14** (12 min) — Dependency Injection : Service decoration · Dependency Injection : Tags · Dependency Injection : Semantic configuration · Dependency Injection : Factories
...
- Révision **J+1** (24 min) — Messenger : Messenger component · Messenger : Transports · Messenger : Messages and handlers · Messenger : Workers
- Révision **J+7** (16 min) — Forms : Data transformers · Forms : Form events · Forms : Form type extensions · Forms : Form options (OptionsResolver component)
- Révision **J+14** (14 min) — Dependency Injection : Compiler passes · Dependency Injection : Services autowiring · Dependency Injection : Service locators · Data Validation : Validator component
...
- Révision **J+1** (26 min) — Messenger : Retries and failures · Messenger : Middleware · Messenger : Events · Templating with Twig : TwigBundle
- Révision **J+7** (16 min) — Security : Security Core, CSRF and PasswordHasher components · Security : Authentication · Security : Authorization · Security : Configuration
- Révision **J+14** (12 min) — Data Validation : PHP object validation · Data Validation : Built-in validation constraints · Data Validation : Validation scopes · Data Validation : Validation groups
...
- Révision **J+1** (26 min) — Templating with Twig : Twig syntax up to 3.22 version · Templating with Twig : Auto escaping · Templating with Twig : Template inheritance · Templating with Twig : Global variables
- Révision **J+3** (16 min) — Messenger : Messenger component · Messenger : Transports · Messenger : Messages and handlers · Messenger : Workers
- Révision **J+7** (16 min) — Security : Providers · Security : Firewalls · Security : Users · Security : Password hashers
- Révision **J+14** (13 min) — Data Validation : Group sequence · Data Validation : Custom callback validators · Data Validation : Violations builder · Forms : Form component
- Révision **J+30** (11 min) — Symfony Architecture : Framework overloading · Symfony Architecture : Release management and roadmap schedule · Symfony Architecture : Framework interoperability and PSRs · Symfony Architecture : Naming conventions
...
- Révision **J+1** (22 min) — Templating with Twig : Filters and functions · Templating with Twig : Template includes · Templating with Twig : Loops and conditions · Templating with Twig : URLs generation
- Révision **J+3** (17 min) — Messenger : Retries and failures · Messenger : Middleware · Messenger : Events · Templating with Twig : TwigBundle
- Révision **J+7** (17 min) — Security : Roles · Security : Access Control Rules · Security : Authenticators, Passports and Badges · Security : Voters and voting strategies
- Révision **J+14** (12 min) — Forms : Forms creation · Forms : Forms handling · Forms : Form types (built-in and custom) · Forms : Forms rendering with Twig
- Révision **J+30** (10 min) — Controllers : HttpKernel component and FrameworkBundle · Controllers : Naming conventions · Controllers : The base AbstractController class · Controllers : The request
...
- **Source tour et mise en pratique** sur les 20 items de la semaine :
  ...
  - Messenger : Events
  - Templating with Twig : TwigBundle
  - Templating with Twig : Twig syntax up to 3.22 version
  - Templating with Twig : Auto escaping
  - Templating with Twig : Template inheritance
  - Templating with Twig : Global variables
  - Templating with Twig : Filters and functions
  - Templating with Twig : Template includes
  - Templating with Twig : Loops and conditions
  - Templating with Twig : URLs generation
  - Templating with Twig : Controller rendering
...
- Révision **J+3** (17 min) — Templating with Twig : Twig syntax up to 3.22 version · Templating with Twig : Auto escaping · Templating with Twig : Template inheritance · Templating with Twig : Global variables
- Révision **J+30** (8 min) — Controllers : The response · Controllers : The cookies · Controllers : The session
...
- Révision **J+3** (15 min) — Templating with Twig : Filters and functions · Templating with Twig : Template includes · Templating with Twig : Loops and conditions · Templating with Twig : URLs generation
- Révision **J+30** (10 min) — Controllers : The flash messages · Controllers : HTTP redirects · Controllers : Internal redirects · Controllers : Generate 404 pages
...
- Révision **J+7** (16 min) — Messenger : Messenger component · Messenger : Transports · Messenger : Messages and handlers · Messenger : Workers
- Révision **J+14** (10 min) — Forms : Forms theming · Forms : CSRF protection · Forms : Handling file upload · Forms : Built-in form types
...
- Révision **J+7** (17 min) — Messenger : Retries and failures · Messenger : Middleware · Messenger : Events · Templating with Twig : TwigBundle
- Révision **J+14** (12 min) — Forms : Data transformers · Forms : Form events · Forms : Form type extensions · Forms : Form options (OptionsResolver component)
...
- Révision **J+7** (17 min) — Templating with Twig : Twig syntax up to 3.22 version · Templating with Twig : Auto escaping · Templating with Twig : Template inheritance · Templating with Twig : Global variables
- Révision **J+14** (12 min) — Security : Security Core, CSRF and PasswordHasher components · Security : Authentication · Security : Authorization · Security : Configuration
- Révision **J+30** (13 min) — Controllers : File upload · Controllers : Built-in internal controllers · Controllers : Argument value resolvers · Routing : Routing component and FrameworkBundle
...
- Révision **J+7** (15 min) — Templating with Twig : Filters and functions · Templating with Twig : Template includes · Templating with Twig : Loops and conditions · Templating with Twig : URLs generation
- Révision **J+14** (12 min) — Security : Providers · Security : Firewalls · Security : Users · Security : Password hashers
- Révision **J+30** (12 min) — Routing : Configuration (YAML and PHP attributes) · Routing : Restrict URL parameters · Routing : Set default values to URL parameters · Routing : URLs generation
...
- Révision **J+14** (13 min) — Security : Roles · Security : Access Control Rules · Security : Authenticators, Passports and Badges · Security : Voters and voting strategies
- Révision **J+30** (11 min) — Routing : Trigger redirects · Routing : Special internal routing attributes · Routing : Domain name matching · Routing : Conditional request matching
...
- **Source tour et mise en pratique** sur les 20 items de la semaine :
  ...
  - Console : Built-in helpers
  - Console : Console events
  - Console : Verbosity levels
  - Automated Tests : Unit tests with PHPUnit
  - Automated Tests : Functional tests with PHPUnit
  - Automated Tests : Client object
  - Automated Tests : Crawler object (CssSelector and DomCrawler components)
  - Automated Tests : Profiler object (WebProfiler bundle)
  - Automated Tests : Framework objects access
  - Automated Tests : Client configuration
...
- Révision **J+30** (10 min) — Routing : HTTP methods matching · Routing : User's locale guessing · Routing : Router debugging · Dependency Injection : Dependency Injection component
...
- Révision **J+30** (11 min) — Dependency Injection : Service container · Dependency Injection : Built-in services · Dependency Injection : Configuration parameters · Dependency Injection : Services registration (YAML and PHP attributes)
...
- Révision **J+14** (12 min) — Messenger : Messenger component · Messenger : Transports · Messenger : Messages and handlers · Messenger : Workers
- Révision **J+45** (10 min) — Symfony Architecture : Code organization · Symfony Architecture : Request handling · Symfony Architecture : Exception handling
...
- Révision **J+14** (13 min) — Messenger : Retries and failures · Messenger : Middleware · Messenger : Events · Templating with Twig : TwigBundle
...
- Révision **J+14** (13 min) — Templating with Twig : Twig syntax up to 3.22 version · Templating with Twig : Auto escaping · Templating with Twig : Template inheritance · Templating with Twig : Global variables
- Révision **J+30** (12 min) — Dependency Injection : Service decoration · Dependency Injection : Tags · Dependency Injection : Semantic configuration · Dependency Injection : Factories
...
- Révision **J+14** (11 min) — Templating with Twig : Filters and functions · Templating with Twig : Template includes · Templating with Twig : Loops and conditions · Templating with Twig : URLs generation
- Révision **J+30** (14 min) — Dependency Injection : Compiler passes · Dependency Injection : Services autowiring · Dependency Injection : Service locators · Data Validation : Validator component
...
- Révision **J+30** (12 min) — Data Validation : PHP object validation · Data Validation : Built-in validation constraints · Data Validation : Validation scopes · Data Validation : Validation groups
...
- Révision **J+30** (13 min) — Data Validation : Group sequence · Data Validation : Custom callback validators · Data Validation : Violations builder · Forms : Form component
...
- Révision **J+30** (12 min) — Forms : Forms creation · Forms : Forms handling · Forms : Form types (built-in and custom) · Forms : Forms rendering with Twig
...
- Révision **J+30** (10 min) — Forms : Forms theming · Forms : CSRF protection · Forms : Handling file upload · Forms : Built-in form types
...
- Révision **J+30** (12 min) — Forms : Data transformers · Forms : Form events · Forms : Form type extensions · Forms : Form options (OptionsResolver component)
...
- Révision **J+30** (12 min) — Security : Security Core, CSRF and PasswordHasher components · Security : Authentication · Security : Authorization · Security : Configuration
...
- **Mock 3** — 68 questions
- Révision **J+30** (12 min) — Security : Providers · Security : Firewalls · Security : Users · Security : Password hashers
...
- Révision **J+30** (13 min) — Security : Roles · Security : Access Control Rules · Security : Authenticators, Passports and Badges · Security : Voters and voting strategies
- Révision **J+45** (3 min) — Dependency Injection : Dependency Injection component
...
- Révision **J+45** (11 min) — Dependency Injection : Service container · Dependency Injection : Built-in services · Dependency Injection : Configuration parameters · Dependency Injection : Services registration (YAML and PHP attributes)
...
- Révision **J+60** (10 min) — Symfony Architecture : Code organization · Symfony Architecture : Request handling · Symfony Architecture : Exception handling

*Budget du jour : 82 / 140 min*
...
- Révision **J+30** (12 min) — Messenger : Messenger component · Messenger : Transports · Messenger : Messages and handlers · Messenger : Workers
...
- Révision **J+30** (13 min) — Messenger : Retries and failures · Messenger : Middleware · Messenger : Events · Templating with Twig : TwigBundle
- Révision **J+45** (12 min) — Dependency Injection : Service decoration · Dependency Injection : Tags · Dependency Injection : Semantic configuration · Dependency Injection : Factories
...
- Révision **J+30** (13 min) — Templating with Twig : Twig syntax up to 3.22 version · Templating with Twig : Auto escaping · Templating with Twig : Template inheritance · Templating with Twig : Global variables
- Révision **J+45** (11 min) — Dependency Injection : Compiler passes · Dependency Injection : Services autowiring · Dependency Injection : Service locators
...
*Budget du jour : 46 / 140 min*

### Samedi 12 décembre 2026

- **Mock 4** — 75 questions / 90 min — holdout, format fixé par §10, une seule fois
- Révision **J+30** (11 min) — Templating with Twig : Filters and functions · Templating with Twig : Template includes · Templating with Twig : Loops and conditions · Templating with Twig : URLs generation
