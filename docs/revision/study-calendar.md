...
- NOUVEAU · **Forms : Form component** (STANDARD) — 11 min · 500 mots · 3 questions, 1 flashcards
- NOUVEAU · **Forms : Forms creation** (STANDARD) — 9 min · 422 mots · 3 questions, 1 flashcards
- NOUVEAU · **Forms : Forms handling** (STANDARD) — 11 min · 442 mots · 3 questions, 1 flashcards
- NOUVEAU · **Forms : Form types (built-in and custom)** (STANDARD) — 9 min · 427 mots · 3 questions, 1 flashcards
- Révision **J+1** (26 min) — Data Validation : Validation groups · Data Validation : Group sequence · Data Validation : Custom callback validators · Data Validation : Violations builder
- Révision **J+3** (18 min) — Dependency Injection : Factories · Dependency Injection : Compiler passes · Dependency Injection : Services autowiring · Dependency Injection : Service locators
...
- NOUVEAU · **Forms : Forms rendering with Twig** (STANDARD) — 9 min · 410 mots · 3 questions, 1 flashcards
- NOUVEAU · **Forms : Forms theming** (STANDARD) — 12 min · 465 mots · 3 questions, 2 flashcards
- NOUVEAU · **Forms : CSRF protection** (STANDARD) — 10 min · 455 mots · 3 questions, 1 flashcards
- NOUVEAU · **Forms : Handling file upload** (MINIMAL) — 7 min · 290 mots · 2 questions, 1 flashcards
- Révision **J+1** (24 min) — Forms : Form component · Forms : Forms creation · Forms : Forms handling · Forms : Form types (built-in and custom)
- Révision **J+3** (16 min) — Data Validation : Validator component · Data Validation : PHP object validation · Data Validation : Built-in validation constraints · Data Validation : Validation scopes
...
- NOUVEAU · **Forms : Built-in form types** (MINIMAL) — 8 min · 383 mots · 2 questions, 1 flashcards
- NOUVEAU · **Forms : Data transformers** (STANDARD) — 11 min · 452 mots · 3 questions, 1 flashcards
- NOUVEAU · **Forms : Form events** (DEEP) — 16 min · 584 mots · 4 questions, 3 flashcards
- NOUVEAU · **Forms : Form type extensions** (MINIMAL) — 7 min · 328 mots · 2 questions, 1 flashcards
- Révision **J+3** (15 min) — Forms : Forms rendering with Twig · Forms : Forms theming · Forms : CSRF protection · Forms : Handling file upload
...
- NOUVEAU · **Forms : Form options (OptionsResolver component)** (STANDARD) — 9 min · 424 mots · 3 questions, 1 flashcards
...
- Révision **J+1** (22 min) — Forms : Built-in form types · Forms : Data transformers · Forms : Form events · Forms : Form type extensions
...
- NOUVEAU · **Messenger : Transports** (STANDARD) — 9 min · 386 mots · 3 questions, 1 flashcards
...
- NOUVEAU · **Messenger : Messages and handlers** (STANDARD) — 10 min · 381 mots · 3 questions, 1 flashcards
- NOUVEAU · **Messenger : Workers** (STANDARD) — 10 min · 408 mots · 3 questions, 1 flashcards
- NOUVEAU · **Messenger : Retries and failures** (DEEP) — 12 min · 542 mots · 4 questions, 1 flashcards
- NOUVEAU · **Messenger : Middleware** (STANDARD) — 10 min · 376 mots · 3 questions, 1 flashcards
...
- NOUVEAU · **Messenger : Events** (STANDARD) — 10 min · 427 mots · 3 questions, 1 flashcards
- NOUVEAU · **Templating with Twig : TwigBundle** (STANDARD) — 10 min · 446 mots · 3 questions, 1 flashcards
- NOUVEAU · **Templating with Twig : Twig syntax up to 3.22 version** (DEEP) — 14 min · 599 mots · 4 questions, 2 flashcards
- NOUVEAU · **Templating with Twig : Auto escaping** (STANDARD) — 10 min · 440 mots · 3 questions, 1 flashcards
...
- NOUVEAU · **Templating with Twig : Template inheritance** (STANDARD) — 9 min · 402 mots · 3 questions, 1 flashcards
- NOUVEAU · **Templating with Twig : Global variables** (STANDARD) — 9 min · 392 mots · 3 questions, 1 flashcards
- NOUVEAU · **Templating with Twig : Filters and functions** (STANDARD) — 10 min · 449 mots · 3 questions, 1 flashcards
- NOUVEAU · **Templating with Twig : Template includes** (STANDARD) — 9 min · 435 mots · 3 questions, 1 flashcards
...
- NOUVEAU · **Templating with Twig : Loops and conditions** (STANDARD) — 12 min · 531 mots · 3 questions, 2 flashcards
- NOUVEAU · **Templating with Twig : URLs generation** (MINIMAL) — 8 min · 341 mots · 2 questions, 1 flashcards
- NOUVEAU · **Templating with Twig : Controller rendering** (STANDARD) — 9 min · 316 mots · 3 questions, 1 flashcards
- NOUVEAU · **Templating with Twig : Translations and pluralization** (STANDARD) — 10 min · 450 mots · 3 questions, 1 flashcards
...
- NOUVEAU · **Templating with Twig : String interpolation** (MINIMAL) — 7 min · 257 mots · 2 questions, 1 flashcards
- NOUVEAU · **Templating with Twig : Assets management** (MINIMAL) — 8 min · 355 mots · 2 questions, 1 flashcards
- NOUVEAU · **Templating with Twig : Debugging variables** (MINIMAL) — 8 min · 346 mots · 2 questions, 1 flashcards
...
- Révision **J+1** (12 min) — Miscellaneous : Process · Miscellaneous : PropertyAccess
...
- Révision **J+3** (8 min) — Miscellaneous : Process · Miscellaneous : PropertyAccess
...
- Révision **J+7** (8 min) — Miscellaneous : Process · Miscellaneous : PropertyAccess
...
- Révision **J+14** (6 min) — Miscellaneous : Process · Miscellaneous : PropertyAccess
